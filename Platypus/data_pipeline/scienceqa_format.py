...
skills_to_remove = ['Choose customary units of distance', 'Choose customary units of mass',
                    'Choose customary units of volume', 'Is it a complete sentence or a run-on',
                    'Is the sentence simple compound, comples, or compound-complex', 'Use guide words']
...
df_reformatted = df_reformatted.rename(
    columns={'question': 'instruction', 'lecture': 'input', 'solution': 'output', 'answer': 'answer'})
...
need_description = ['What information supports', 'Based on', 'Read the following', 'Use the evidence', 'Look at the',
                    'According to a']
...
df_reformatted.drop(['correct_answer', 'answer', 'contains_description'], axis=1).to_json('scienceqa_formatted.json',
