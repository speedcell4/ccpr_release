...
keywords_expanded = [
    ...
    # General STEM
                                              "science", "technology", "engineering", "physics", "chemistry", "biology",
    "computer science",
...
def format_question(data_entry):
    ...
    return {"instruction": formatted_question, "input": "Choose A, B, C or D as your solution.",
...
filtered_data_keywords_reclor = [item for item in reclor_data if any(
    re.search(r'\b' + keyword + r'\b', item['instruction'].lower()) for keyword in keywords_expanded)]
