...
from utils.prompter import Prompter, LlamaChatPrompter
...
def train(
    ...
    if hf_cache_dir:
        model = LlamaForCausalLM.from_pretrained(
            ...
            device_map=device_map, cache_dir=hf_cache_dir)
    ...
    trainer = transformers.Trainer(
        ...
        args=transformers.TrainingArguments(
            ...
            fp16=True if not enable_bf16 else False,
            bf16=True if enable_bf16 else False,
            logging_steps=1,
            optim="adamw_torch",
